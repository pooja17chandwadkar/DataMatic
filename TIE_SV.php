      ...
      // connection successfull
        ...
        if($result->num_rows > 0){
         while ($row_val = $result->fetch_assoc()){
            $tieSVobj= new TieFighter_SV( $row_val["Model"], $row_val["Class"], $row_val["Cost"], $row_val["Manufacturer"], $row_val["Length"], $row_val["Width"], $row_val["Height"], $row_val["Mass"], $row_val["Crew"], $row_val["MaxSpeed"], $row_val["MaxClimb"], $row_val["Armament"], $row_val["Propulsion"], $row_val["Hull"],' ','',' ');

          
          echo "<h2>" .$tieSVobj->displayFighterInfo(). "</h2>";
        }
        }else{
        ...
        <button type="button" class="button4" style="width: 100px;" onclick="location= 'SVInventory.php'"> TIE SV Inventory</button>
        </form> 
        </div>
      </body>
    </html>  
