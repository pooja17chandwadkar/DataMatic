...
.center{
    ...
    <body>
         <div style="background-color: black;width: 800px;height: 300px;">
...
//        // connection successfull
        ...
        <button type="button" class="button4" style="width: 80px;" onclick="location= 'TIE_S.php'"> TIE S Data</button>
        </form> 
        </div>
      </body>
    </html>  
