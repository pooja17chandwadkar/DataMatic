...
.center{
    ...
    <body>
         <div style="background-color: black;width: 700px;height: 300px;">
        ...
        <button type="button" class="button4" style="width: 80px;" onclick="location= 'TIE_I.php'"> TIE I Data</button>
        </form> 
        </div>
      </body>
    </html>  
